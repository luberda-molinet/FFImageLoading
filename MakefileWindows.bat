...
"C:\Program Files (x86)\MSBuild\14.0\bin\msbuild.exe" source/FFImageLoading.WinSL/FFImageLoading-contrib.WinSL.csproj /nologo /p:Configuration="Windows Release" /consoleloggerparameters:ErrorsOnly /verbosity:minimal
