...
namespace FFImageLoading.Forms.WinSL
{
    ...
    /// </summary>
    public class CachedImageRenderer : ViewRenderer<CachedImage, System.Windows.Controls.Image>
    {
        ...
        public override SizeRequest GetDesiredSize(double widthConstraint, double heightConstraint)
        {
            ...
            return new SizeRequest(new Xamarin.Forms.Size()
            {
        ...
        private async Task<byte[]> GetImageAsByte(Guid format, int quality, int desiredWidth, int desiredHeight)
        {
            ...
            if (desiredWidth != 0 || desiredHeight != 0)
            {
                ...
                {
                    byte[] tempPixels = bitmap.ToByteArray();
