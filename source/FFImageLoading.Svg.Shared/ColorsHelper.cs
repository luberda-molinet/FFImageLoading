...
namespace FFImageLoading.Svg.Platform
{
    ...
    {
        public static bool TryParse(string hexOrNamedColor, out SKColor color)
        {
            if (!SKColor.TryParse(hexOrNamedColor, out color))
            {
                string hexString = null;
                if (HexValues.TryGetValue(hexOrNamedColor, out hexString))
                {
