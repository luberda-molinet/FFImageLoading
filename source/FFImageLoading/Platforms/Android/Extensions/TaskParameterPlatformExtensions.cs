...
//        public static IScheduledWork Into(this TaskParameter parameters, ImageView imageView, IMiniLogger logger)
//        {
//            var target = new ImageViewTarget(imageView, logger);
//            return parameters.Into(target, logger);
//        }
...
//        /// <param name="parameters">Parameters for loading the image.</param>
//        /// <param name="imageView">Image view that should receive the image.</param>
//        public static Task<IScheduledWork> IntoAsync(this TaskParameter parameters, ImageView imageView, IMiniLogger logger)
//        {
//            return parameters.IntoAsync(param => param.Into(imageView, logger));
//        }
...
//        /// <param name="target">Target.</param>
//        /// <typeparam name="TImageView">The 1st type parameter.</typeparam>
//        public static Task<IScheduledWork> IntoAsync<TImageView>(this TaskParameter parameters, ITarget<SelfDisposingBitmapDrawable, TImageView> target, IMiniLogger logger, IImageService imageService) where TImageView : class
//        {
//            return parameters.IntoAsync(param => param.Into<TImageView>(target, imageService), logger);
//        }
