...
#pragma warning restore RECS0108 // Warns about static fields in generic types
            ...
            if (image is FFBitmapDrawable ffDrawable)
            {
                ...
                if (animated)
                {
                    ...
                    else if (ffDrawable.IsValidAndHasValidBitmap())
                    {
                        ...
                        using (var paint = new Android.Graphics.Paint() { Color = _placeholderHelperColor })
                        {
        ...
        protected override async Task<Bitmap> TransformAsync(Bitmap bitmap, IList<ITransformation> transformations, string path, Work.ImageSource source, bool isPlaceholder)
        {
